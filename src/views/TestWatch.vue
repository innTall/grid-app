...
<template>
	<div class="">
		<div v-for="symbol in symbols" :key="symbol.symbol" class="flex justify-between pl-2 p-1 mt-1 rounded-xl border hover:bg-gray-600 border-green-600 items-center">
			<div class="flex items-center gap-2">
				<input type="checkbox" value="" id="fb" class="form-check-input appearance-none h-6 w-4 border border-green-600 rounded-lg bg-gray-600 checked:bg-green-700 checked:border-2 checked:border-white focus:outline-none align-top">
			...
			<div class="flex justify-end gap-3 items-center">
				...
				<TrashIcon @click="removeSymbol(symbol)" class="h-8 w-6 text-red-700" />
			</div>
		</div>
	</div>
</template>
